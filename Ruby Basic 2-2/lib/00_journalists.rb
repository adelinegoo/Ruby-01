...
# Afficher les comptes twitter par ordre alphabétique.
  def order
  puts "Afficher les comptes twitter par ordre alphabétique."
  db_user.sort { |a,b| a <=> b=>}
  end

# Afficher les 50 comptes twitter les plus courts.
  db_users.sort_by (&length)
  puts "Afficher les 50 comptes twitter les plus courts."

# Position du compte @epenser sur Twitter?
  puts "Position du compte @epenser sur Twitter?"
